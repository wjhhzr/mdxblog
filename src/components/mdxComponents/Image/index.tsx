...
import VideoGif from 'src/components//video'
import { aspectRatioHack } from 'src/lib/function/cssMixins'
    ...
    return (
        <PhotoWrapper type={props.type} >
            <ImageWrapper type={props.type} isReverse={isReverse} >
                <NextImage {...props} layout="fill" objectFit="contain" alt={props.alt} />
            </ImageWrapper>
            <ImgTipWrapper >
                <ImgTip>
                    {alt}
